  ...
  rules: {
    ...
    "no-restricted-syntax": [
      ...
      },
      {
        ...
        message:
          "`with` is disallowed in strict mode because it makes code impossible to predict and optimize. It is also deprecated.",
      },
    ],
    "no-restricted-properties": [
      ...
      // which correctly updates `hybridApp.closingReactNativeApp` when closing NewDot
      {
        ...
        message:
          "Use `closeReactNativeApp` from `@userActions/HybridApp` instead.",
      },
    ],
