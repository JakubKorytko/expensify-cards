...
const MULTI_FACTOR_AUTHENTICATION_VALUES = {
    ...
    FACTOR_COMBINATIONS: {
        REGISTRATION: [MULTI_FACTOR_AUTHENTICATION_FACTORS.VALIDATE_CODE],
        FALLBACK: [MULTI_FACTOR_AUTHENTICATION_FACTORS.VALIDATE_CODE, MULTI_FACTOR_AUTHENTICATION_FACTORS.OTP],
